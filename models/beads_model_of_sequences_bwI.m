...
seq_mat = [sequence1; sequence2];
 ...
 %need sequence and behavior, but behavior needs to be in its old format
           ...
           [ll, pickTrial, dQvec, ddec, aQvec choice] = estimateLikelihoodf(alpha,Cw,q,Cs,seq_mat,model_behavior,1);
...
function [ll, pickTrial, dQvec, ddec, aQvec choice] = estimateLikelihoodf(alpha,Cw,q,Cs, sequence, setData, aqvec_switch);
