...
p = anovan(draws,{probability agent},'model','interaction','varnames',{'probability','agent_type'})

% two-way anova on accuracy
p = anovan(accuracy,{probability agent},'model','interaction','varnames',{'probability','agent_type'})

[p,~,stats] = anovan(accuracy,{probability agent},"Model","interaction", ...
    "Varnames",["probability","agent_type"]);
...
% run anova
[pvals,~,stats] = anovan(draws, {agent probability}, ... 
'model','interaction', 'random',1,'varnames',{'agent' 'probability'});

[pvals,tbl,stats] = anovan(accuracy, {agent probability}, ... 
'model',2, 'random',1,'varnames',{'agent' 'probability'})
