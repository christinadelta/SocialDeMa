...
% 1. FIXED 
% 14/06/23 --> need to recode how I save the output from parameter recovery (FIXED)
% of Cs_beta model --> FIXED BUG ON 15/06/2023

% 2.
% 15/06/2023 --> need to write a function that plots bar plots with stat
% significance (stars). For now I am using R and Ai.

% 3.
% 15/06/2023 --> need to plot parameter recovery results 
% 23/06/2023 --> scatter plots for sampling rates recovery looks weird
% 23/06/2023 --> scatter plot/correlation for simulated/fit parameters looks also weird
