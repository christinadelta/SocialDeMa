function [v, d, Qvec] = Val_io(q, numDraws, numGreen, alpha, lseq, Cw,Cc,Cs)
...
pg          = PG_io(q, numDraws, numGreen); %  p(G|numDraws, numGreen)
...
if numDraws + 1 <= lseq
    ...
    val11   = vVal_io(q, numDraws+1, numGreen+1, alpha, lseq, Cw,Cc, Cs);
