...
% to create the trial definition mat file, we need to run the function
% "[trl, conditionlabels, S] = spm_eeg_definetrial(S)"

% use trial definition mat file for the S structure (to be converted into
% epoched MEEG object)
S = [];
S.D = '/Users/christinadelta/Desktop/os_data/beads/spmdir/output/fdfMspmeeg_sub_01_beads_block_01.mat'; % MEEG object
