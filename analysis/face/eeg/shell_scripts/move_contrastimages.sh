...
# created in February 2023 @christinadelta
...
basedir="/Users/christinadelta/githubstuff/rhul_stuff/SocialDeMa/analysis/face/eeg/"
bashdir=$basedir$"shell_scripts"
datadir="/Volumes/DeepSpaceStuff/optimal_stopping_data/face/"
...
# 1. first move to the erp contrats and then to tfr contrasts
  ...
  tmpdir=$subout$"wra_maceerpfdfMspmeeg_${tmp}face_block_01" # accept vs reject contrast dir
  tmpdir2=$subout$"wr_maceerpfdfMspmeeg_${tmp}face_block_01" # only reject contrast dir
  tmpdir3=$subout$"wa_maceerpfdfMspmeeg_${tmp}face_block_01" # only accept contrast dir
  ...
  tmpdir=$subout$"wra_mPrtf_cetfrfdfMspmeeg_${tmp}face_block_01" # accept vs reject contrast dir
  tmpdir2=$subout$"wr_mPrtf_cetfrfdfMspmeeg_${tmp}face_block_01" # only reject contrast dir
  tmpdir3=$subout$"wa_mPrtf_cetfrfdfMspmeeg_${tmp}face_block_01" # only accept contrast dir
